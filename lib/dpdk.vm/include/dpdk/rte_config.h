...
#undef RTE_LIBRTE_MLX5_REGEX_PMD
...
#undef RTE_LIBRTE_REGEXDEV
#define RTE_LIBRTE_REGEXDEV 1
#undef RTE_LIBRTE_REGEXDEV_DEBUG
#undef RTE_MAX_REGEXDEV_DEVS
...
#undef RTE_TEST_FLOW_PERF
#define RTE_TEST_FLOW_PERF 1
