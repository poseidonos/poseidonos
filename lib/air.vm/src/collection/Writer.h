...
public:
    ...
    inline void
    LogData(lib::Data* data, uint64_t io_type, uint64_t io_size)
    {
...
public:
    ...
    inline void
    LogData(lib::Data* data, uint64_t seq_index, uint64_t key)
    {
...
public:
    ...
    inline void
    LogData(lib::Data* data, uint64_t q_depth, uint64_t q_size)
    {
