...
func TestListArrayResHumanReadable(t *testing.T) {
	...
	var resJSON = `{"Response": {"result":{"status":{"code":0, "eventName":"SUCCESS", "description":"", "cause":"", "solution":""}, "data":[{"name":"POSArray", "status":"Unmounted", "createDatetime":"2022-05-31 08:13:19 +0000", "updateDatetime":"2022-05-31 08:13:19 +0000", "capacity":"119829587559", "dataRaid":"RAID5"}]}, "info":{"version":"v0.11.0-rc6"}} }
`
