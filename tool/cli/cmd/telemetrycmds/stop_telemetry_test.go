...
func TestStopSystemCommandReq(t *testing.T) {
	...
	testmgr.ExecuteCommand(rootCmd, "telemetry", "stop", "--json-req")
	...
	expected := `{"Request": {"command":"STOPTELEMETRY","rid":"fromfakeclient","param":null} }
`
