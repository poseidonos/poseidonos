...
func TestUnmountArrayCommandReq(t *testing.T) {
	...
	testmgr.ExecuteCommand(rootCmd, "array", "unmount", "--array-name", "Array0", "--json-req", "--force")
	...
	expected := `{"command":"UNMOUNTARRAY","rid":"fromCLI","param":{"name":"Array0"}}`
