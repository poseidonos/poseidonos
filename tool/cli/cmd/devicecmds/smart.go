...
Syntax:
	poseidonos-cli device smart --device-name DeviceName .
          `,
...
func init() {
	SMARTCmd.Flags().StringVarP(&smart_deviceName, "device-name", "", "", "The name of device to get the SMART information")
}
