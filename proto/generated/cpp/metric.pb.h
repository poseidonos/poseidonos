...
class MetricPublishRequest final :
 ...
 public:
  ...
  inline MetricPublishRequest* New() const final {
    return new MetricPublishRequest();
  }
...
class MetricPublishResponse final :
 ...
 public:
  ...
  ~MetricPublishResponse() override;
  ...
  inline MetricPublishResponse* New() const final {
    return new MetricPublishResponse();
  }
...
class Metric final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::HistogramValue* release_histogramvalue();
...
inline ::Metric* MetricPublishRequest::add_metrics() {
  ::Metric* _add = _internal_add_metrics();
...
inline void Metric::clear_countervalue() {
  if (_internal_has_countervalue()) {
    value_.countervalue_ = uint64_t{0u};
    clear_has_value();
  }
}
...
inline ::HistogramValue* Metric::_internal_mutable_histogramvalue() {
  if (!_internal_has_histogramvalue()) {
    clear_value();
    set_has_histogramvalue();
    value_.histogramvalue_ = CreateMaybeMessage< ::HistogramValue >(GetArenaForAllocation());
  }
  return value_.histogramvalue_;
}
inline ::HistogramValue* Metric::mutable_histogramvalue() {
  ::HistogramValue* _msg = _internal_mutable_histogramvalue();
...
inline ::Label* Metric::add_labels() {
  ::Label* _add = _internal_add_labels();
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Label::set_key(ArgT0&& arg0, ArgT... args) {
