...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_http_2eproto_metadata_getter(int index);
namespace google {
namespace api {
...
class Http PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_http_2eproto_metadata_getter(kIndexInFileMessages);
  }
