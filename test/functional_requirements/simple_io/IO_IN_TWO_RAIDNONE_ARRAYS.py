...
import api
import json
import MOUNT_VOLS_ON_TWO_RAIDNONE_ARRAYS
import fio
import time
ARRAY1NAME = MOUNT_VOLS_ON_TWO_RAIDNONE_ARRAYS.ARRAY1NAME
ARRAY2NAME = MOUNT_VOLS_ON_TWO_RAIDNONE_ARRAYS.ARRAY2NAME

def execute():
    MOUNT_VOLS_ON_TWO_RAIDNONE_ARRAYS.execute()
