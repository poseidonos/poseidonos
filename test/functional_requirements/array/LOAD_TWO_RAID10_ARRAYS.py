...
import api
import json_parser
import UNMOUNT_TWO_RAID10_ARRAYS

ARRAY1NAME = UNMOUNT_TWO_RAID10_ARRAYS.ARRAY1NAME
ARRAY2NAME = UNMOUNT_TWO_RAID10_ARRAYS.ARRAY2NAME

def execute():
    UNMOUNT_TWO_RAID10_ARRAYS.execute()
    pos.exit_pos()
    time.sleep(5)
