...
public:
    ...
    MOCK_METHOD(void, Register, (std::string arrayName, int arrayId, IJournalManager* journal, IJournalWriter* writer, IVolumeEventHandler* handler, IJournalStatusProvider* provider), (override));
