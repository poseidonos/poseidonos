...
public:
    ...
    MOCK_METHOD(IOSubmitHandlerStatus, SubmitAsyncByteIO, (IODirection direction, void* buffer, LogicalByteAddr& startLSA, PartitionType partitionToIO, CallbackSmartPtr callback, std::string arrayName), (override));
