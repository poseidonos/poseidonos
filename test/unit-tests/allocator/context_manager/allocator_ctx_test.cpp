...
namespace pos
{
TEST(AllocatorCtx, AllocatorCtx_)
{
}

TEST(AllocatorCtx, Init_)
{
}

TEST(AllocatorCtx, Close_)
{
}
...
TEST(AllocatorCtx, BeforeFlush_)
{
}

TEST(AllocatorCtx, FinalizeIo_)
{
}

TEST(AllocatorCtx, GetSectionAddr_)
{
}

TEST(AllocatorCtx, GetSectionSize_)
{
}
...
TEST(AllocatorCtx, GetCurrentSsdLsid_)
{
}

TEST(AllocatorCtx, GetPrevSsdLsid_)
{
}
...
TEST(AllocatorCtx, GetSegStateLock_)
{
}

TEST(AllocatorCtx, GetAllocatorCtxLock_)
{
}
