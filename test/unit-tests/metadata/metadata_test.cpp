...
TEST(Metadata, Metadata_testContructor)
{
...

    {
        ...
        NiceMock<MockJournalManager>* journal = new NiceMock<MockJournalManager>(nullptr, &arrayInfo, &stateControl);
...

    {
        ...
        // When 3
        Metadata* metataInHeap = new Metadata(&arrayInfo, mapper, allocator, journal, &metaService);
        delete metataInHeap;
    }
