...
public:
    ...
    MOCK_METHOD(int, FlushDirtyPagesGiven, (int volId, MpageList dirtyPages, EventSmartPtr cb), (override));
    ...
    MOCK_METHOD(void, SetVSAMapContent, (int volId, VSAMapContent* conts), (override));
