...
public:
    ...
    MOCK_METHOD(void, Init, (StripeId wblsid, IVSAMap* ivsaMap, IStripeMap* istripeMap), (override));
    ...
    MOCK_METHOD(int, ReconstructMap, (uint32_t volumeId, StripeId vsid, StripeId lsid, uint64_t blockCount), (override));
