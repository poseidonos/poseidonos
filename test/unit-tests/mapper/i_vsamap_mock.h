...
public:
    ...
    MOCK_METHOD(VirtualBlkAddr, GetVSAforReplay, (int volumeId, BlkAddr rba), (override));
    MOCK_METHOD(int, SetVSAsforReplay, (int volumeId, BlkAddr startRba, VirtualBlks& virtualBlks), (override));
