...
TEST(ArrayComponents, ArrayComponents_testConstructorWithNullPtrs)
{
    ...
    // When
    ArrayComponents arrayComps("mock-array", nullptr, &mockStateManager,
...
TEST(ArrayComponents, Create_testIfRemoveStateIsInvokedWhenCreationFails)
{
    ...
    ArrayComponents arrayComps("mock-array", nullptr, &mockStateManager, nullptr, mockArray,
...
TEST(ArrayComponents, Create_testIfGetStateAndSubscribeIsInvokedWhenCreationSucceeds)
{
    ...
    ArrayComponents arrayComps("mock-array", nullptr, &mockStateManager, &mockStateControl, mockArray,
...
TEST(ArrayComponents, PrepareRebuild_testIfGcIsPausedAndResumedAroundAllocatorPreparingRebuild)
{
    ...
    ArrayComponents arrayComps("mock-array", nullptr, &mockStateManager, nullptr, nullptr,
