...
TEST(JsonFormat, MakeResponse_testJsonFormatIfElementContainsArray)
{
    ...
    string expected = "{\"command\":\"PEOPLE\",\"rid\":\"0000\",\"result\":{\"status\":{\"code\":0,\"eventName\":\"SUCCESS\",\"description\":\"List of people\",\"cause\":\"\",\"solution\":\"\"},\"data\":{\"people\":[{\"name\":\"foo\",\"id\":1},{\"name\":\"bar\",\"id\":2}]}},\"sign\":{\"ver\":\" 1.0 + \"}}";
...
TEST(JsonFormat, MakeResponse_testJsonFormatIfDataElementIsNotIncluded)
{
    ...
    string expected = "{\"command\":\"PEOPLE\",\"rid\":\"1111\",\"result\":{\"status\":{\"code\":0,\"eventName\":\"SUCCESS\",\"description\":\"There is no person\",\"cause\":\"\",\"solution\":\"\"}},\"sign\":{\"ver\":\" 1.0 + \"}}";
