...
public:
    ...
    MOCK_METHOD(int, GetTargetAddress, (string name, string& address), (override));
    MOCK_METHOD(ComponentsInfo*, GetInfo, (string name), (override));
    MOCK_METHOD(ComponentsInfo*, GetInfo, (uint32_t arrayIdx), (override));
    MOCK_METHOD(vector<const ComponentsInfo*>, GetInfo, (), (override));
    ...
    MOCK_METHOD(int, ResetPbr, (), (override));
};
