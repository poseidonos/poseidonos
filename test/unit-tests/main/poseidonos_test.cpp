...
TEST(Poseidonos, InitTraceExporter_)
{
    ...
    MockTraceExporter *te = new MockTraceExporter;
    ...
    // When
    int ret = pos->InitTraceExporter((char*)"/home/pos/ibofos/src/../bin/poseidonos", cm, vp, te);
...
TEST(Poseidonos, InitTraceExporterWithConfigError1_)
{
    // Given
    Poseidonos *pos = new Poseidonos;
    MockConfigManager *cm = new MockConfigManager;
...
TEST(Poseidonos, InitTraceExporterWithConfigError2_)
{
    // Given
    Poseidonos *pos = new Poseidonos;
    MockConfigManager *cm = new MockConfigManager;
...
TEST(Poseidonos, InitTraceExporterWithNotEnabled_)
{
    // Given
    Poseidonos *pos = new Poseidonos;
    MockConfigManager *cm = new MockConfigManager;
