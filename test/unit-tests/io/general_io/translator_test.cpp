...
TEST_F(TranslatorTestFixture, Translator_Constructor_EightArguments)
{
    ...
    Translator translator(0, 0, 1, arrayName, true, mockIVSAMap, mockIStripeMap, mockWBAllocator, mockITranslator);

    //Then: do nothing

    //When: create translator for mulitple blocks
    Translator translator2(0, 0, 2, arrayName, true, mockIVSAMap, mockIStripeMap, mockWBAllocator, mockITranslator);
    //Then: do nothing

    //When: create translator (heap)
    Translator* pTranslator = new Translator(0, 0, 1, arrayName, true, mockIVSAMap, mockIStripeMap, mockWBAllocator, mockITranslator);
    delete pTranslator;
    //Then: do nothing
}
...
TEST_F(TranslatorTestFixture, Translator_Constructor_TwoArguments)
{
    ...
    Translator translator(vsa, arrayName);
...
TEST_F(TranslatorTestFixture, Translator_Constructor_FourArguments)
{
    ...
    Translator translator(0, 0, arrayName, true);

    Translator* pTranslator = new Translator(0, 0, arrayName, true);
    delete pTranslator;
    //Then: do nothing
}
...
TEST_F(TranslatorTestFixture, Translator_Constructor_InvalidVolumeIdException)
{
    ...
    EXPECT_THROW(Translator translator(MAX_VOLUME_COUNT, 0, 1, arrayName, true, mockIVSAMap, mockIStripeMap, mockWBAllocator, mockITranslator), POS_EVENT_ID);
}
...
TEST_F(TranslatorTestFixture, GetVsa)
{
    ...
    Translator translator2(0, 2, 1, arrayName, true, mockIVSAMap, mockIStripeMap, mockWBAllocator, mockITranslator);
...
TEST_F(TranslatorTestFixture, IsMapped)
{
    ...
    Translator translator3(0, 0, 2, arrayName, true, mockIVSAMap, mockIStripeMap, mockWBAllocator, mockITranslator);
