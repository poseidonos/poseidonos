...
TEST(EventScheduler, EventScheduler_Heap)
{
    ...
    // When: Create EventScheduler
    EventScheduler* eventSechduler = new EventScheduler;
...
TEST(EventScheduler, EnqueueEvent_FrontendIO)
{
    ...
    EXPECT_CALL(*mockEventSharedPtr.get(), IsFrontEnd()).Times(1);
...
TEST(EventScheduler, EnqueueEvent_NotFrontendTypes)
{
    ...
    EXPECT_CALL(*mockEventSharedPtr1.get(), GetEventType()).Times(3);
    EXPECT_CALL(*mockEventSharedPtr1.get(), IsFrontEnd()).Times(1);
    ...
    EXPECT_CALL(*mockEventSharedPtr2.get(), GetEventType()).Times(3);
    EXPECT_CALL(*mockEventSharedPtr2.get(), IsFrontEnd()).Times(1);
    ...
    EXPECT_CALL(*mockEventSharedPtr3.get(), GetEventType()).Times(3);
    EXPECT_CALL(*mockEventSharedPtr3.get(), IsFrontEnd()).Times(1);
    ...
    EXPECT_CALL(*mockEventSharedPtr4.get(), GetEventType()).Times(3);
    EXPECT_CALL(*mockEventSharedPtr4.get(), IsFrontEnd()).Times(1);
    ...
    EXPECT_CALL(*mockEventSharedPtr5.get(), GetEventType()).Times(3);
    EXPECT_CALL(*mockEventSharedPtr5.get(), IsFrontEnd()).Times(1);
    ...
    EXPECT_CALL(*mockEventSharedPtr6.get(), GetEventType()).Times(3);
    EXPECT_CALL(*mockEventSharedPtr6.get(), SetEventType(_)).Times(1);
    EXPECT_CALL(*mockEventSharedPtr6.get(), IsFrontEnd()).Times(1);
    auto mockEventSharedPtr7 = std::make_shared<MockEvent>();
    ON_CALL(*mockEventSharedPtr7.get(), IsFrontEnd()).WillByDefault(Return(false));
    ON_CALL(*mockEventSharedPtr7.get(), GetEventType()).WillByDefault(Return(BackendEvent_End));
    EXPECT_CALL(*mockEventSharedPtr7.get(), GetEventType()).Times(0);
    ...
    EXPECT_DEATH(eventScheduler.EnqueueEvent(mockEventSharedPtr7), "");
