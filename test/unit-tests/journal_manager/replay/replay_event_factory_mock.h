...
public:
    ...
    MOCK_METHOD(ReplayEvent*, CreateBlockWriteReplayEvent, (int volId, BlkAddr startRba, VirtualBlkAddr startVsa, uint64_t numBlks, bool replaySegmentInfo), (override));
