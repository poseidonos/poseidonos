...
namespace pos
{
class MockOffsetInFile : public OffsetInFile
{
public:
    using OffsetInFile::OffsetInFile;
};
...
public:
    ...
    MOCK_METHOD(int, AllocateBuffer, (uint32_t logSize, OffsetInFile& allocated), (override));
