...
TEST(DiskQueryManager, DiskQueryManager_Contructor_One)
{
    ...
    DiskQueryManager diskQueryManager(&cmd, &buffer, &ibofIo, originCore, callback, &arrayInfo, &devInfo, &ioDispatcher, &arrayDevMgr);
}
...
TEST(DiskQueryManager, DiskQueryManager_Contructor_One_Heap)
{
    ...
    DiskQueryManager* diskQueryManager = new DiskQueryManager(&cmd, &buffer, &ibofIo, originCore, callback, &arrayInfo, &devInfo, &ioDispatcher, &arrayDevMgr);
