...
def parse_argument():
    ...
    parser.add_argument('--verify', required=False, help='Please verify option as true or false Ex) --verify=true or --verify=false');
    ...
    parser.add_argument('--traddr', required=False, help='Set target address ');
    parser.add_argument('--trtype', required=False, help='Set transfer type (tcp or rdma) ');
    ...
    if(args.traddr!=None):
        filename=filename.replace("traddr=172.16.1.1","traddr="+args.traddr)
