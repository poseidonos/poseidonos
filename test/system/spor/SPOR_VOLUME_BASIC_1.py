...
def execute():
    ...
    volume_to_create = 2
    TEST_SETUP_POS.create_subsystem(volume_to_create)
    TEST_SETUP_POS.create_volume(volume_to_create)
...
if __name__ == "__main__":
    ...
    TEST_SETUP_POS.create_subsystem(volumeId=1)
    TEST_SETUP_POS.create_volume(volumeId=1)
