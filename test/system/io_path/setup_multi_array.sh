...
DEFAULT_TARGET_IP=111.100.13.175 # CI Server VM IP
DEFAULT_SUBSYSTEM_COUNT=2
DEFAULT_WRITE_BUFFER_SIZE_IN_MB=4096
DEFAULT_NUM_SHARED_BUFFER=4096
DEFAULT_VOLUME_COUNT=8
DEFAULT_VOLUME_SIZE=2147483648
DEFAULT_IRQ_DEDICATION=FALSE
USER_DEVICE_LIST1="-d unvme-ns-0,unvme-ns-1,unvme-ns-2"
USER_DEVICE_LIST2="-d unvme-ns-3,unvme-ns-4,unvme-ns-5"
