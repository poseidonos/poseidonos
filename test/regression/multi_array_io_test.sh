...
io_test()
{
	texecc ${POS_ROOT}/test/system/nvmf/initiator/fio_full_bench.py --iodepth 128 --io_size 2g --file_num 2 --verify=true --readwrite="write,read" --ramp_time 0 --run_time 0 --time_based 0 --bs 4k,128k --trtype tcp --traddr $target_fabric_ip
}
...
echo -e "\n\033[1;32m multi array io test has been finished! \033[0m"
