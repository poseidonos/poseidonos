...
lcov --rc lcov_branch_coverage=1 -r coverage.info '/usr/*' '*/unit-tests/*' '*/integration-tests/*' '*/spdlog-1.4.2/*' '*/include/nlohmann/json.hpp' '*/test/utils/*' '*/air/src/*' -o coverage_filtered.lcov
...
mkdir -p build
genhtml coverage_filtered_pos.lcov --output-directory build/coverage-html  --rc lcov_branch_coverage=1 
