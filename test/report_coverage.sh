...
lcov --rc lcov_branch_coverage=1 -r coverage.info '/usr/*' '*/unit-tests/*' '*/integration-tests/*' '*/spdlog-1.4.2/*' '*/include/nlohmann/json.hpp' '*/test/utils/*' -o coverage_filtered.lcov
