...
def config_reset():
    ...
    config_file = "../config/ibofos.conf"
    if os.path.isfile(config_file) == False:
        print("cannot find ibofos.conf")
        return False
    else:
        command = ["/bin/bash", "-i" , "-c", "cp -f " + config_file + " /etc/ibofos/conf/"]
...
if __name__ == "__main__":
    ...
    print (" - All ibofos logs will be removed")
