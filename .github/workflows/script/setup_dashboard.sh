...
make_dashboard_link()
{
    ...
    GRAFANA_DASHBOARD_DIRECT=$(echo ${GRAFANA_DASHBOARD}"&refresh=10s&from=${START_TIME}&to=${START_TIME}+${}&var-ga_commit_hash=${GA_COMMIT_HASH}&var-ga_workflow=${GA_WORKFLOW}" | sed 's/#/%23/g')
